...
const Singleproject2 = () => {
  return (
    <>
      <Navbar />
      <section className='single-section res-section'>
        <div className='row'>
            <div className='col-12 col-lg-6 '>
            <h1 className='project-headingone'>{ProjectApi[2].title}</h1>
            <p className='single-paraone'>{ProjectApi[2].info}</p>
            <button className='project-button'>Buy Now $99 </button>
            <button className='project-button res-b'>Live Demo</button>
            </div>

            <div className='col-12 col-lg-6 justify-content-center '>
                <div className='row'>
                <div className='col-11 col-lg-6'>
                <img src={ProjectApi[2].img} alt="photos" className='single-imgone' />
                </div>
                </div>
            </div>    
