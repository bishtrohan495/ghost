    ...
    <>
      ...
      <section className='single-section'>
        <div className='row'>
            ...
            <h1 className='project-headingone'>{ProjectApi[1].title}</h1>
            <p className='single-paraone'>{ProjectApi[1].info}</p>
            ...
            <div className='col-12 col-lg-6 justify-content-center '>
                ...
                <img src={ProjectApi[1].img} alt="photos" className='single-imgone' />
                </div>
                </div>
            </div>    
