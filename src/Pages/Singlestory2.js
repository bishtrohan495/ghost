  ...
  return (
    ...
    <section className='single-section'>
      <div className='row'>
          ...
          <h1 className='single-headingone'>{StoriesApi[2].title}</h1>
          <p className='single-paraone'>{StoriesApi[2].info}</p>
          </div>

          <div className='col-12 col-lg-6 justify-content-center '>
              <div className='row'>
              <div className='col-11 col-lg-6'>
              <img src={StoriesApi[2].img} alt="photos" className='single-imgone' />
              </div>
              </div>
          </div>    
